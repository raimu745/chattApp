...
<div class="messaging">
      <div class="inbox_msg">
        <div class="inbox_people">
          ...
          <div class="inbox_chat">
            ...
            <div class="chat_list" data-id="{{$user->id}}" style="cursor:pointer;">
              <div class="chat_people">
                <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                <div class="chat_ib">
            <!-- <input type="text" value="{{$user->id}}" data-id="{{$user->id}}" class="new" > -->
        ...
        <div class="mesgs">
          <div class="msg_history">
           <div><h1>Welcome to chat app</h1></div>
    ...
    $(document).ready(function(){
         var receiver_id = 0;
        $(this).on('click','.chat_list',function(){
        //   alert(123);
